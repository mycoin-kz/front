...
export const GOOGLE_CLIENT_ID = '791604705325-uukmdg4rat6miu3gimmk0ct5ohv8sd1f.apps.googleusercontent.com'
export const GOOGLE_REDIRECT_URI = base_url + 'auth/google/'
export const GOOGLE_SCOPES = encodeURI('https://www.googleapis.com/auth/userinfo.profile https://www.googleapis.com/auth/userinfo.email openid')
